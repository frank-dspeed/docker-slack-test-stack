...
// Here we Could Probally Insert Installation of the whole process parts to run the tests so we should maybe consider to simply do that and run it in a container without modification :)
